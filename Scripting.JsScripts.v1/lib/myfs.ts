...
declare var _scriptingContext;

export class Myfs {
    isNodeDefined;
    nodeFs;
    isScriptingContextDefined;
    ...
    constructor() {
        ...
        if (!this.isNodeDefined && !this.isScriptingContextDefined) { throw 'both node.js and _scriptingContext are not defined'; };
    }
